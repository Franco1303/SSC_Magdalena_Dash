...
\## Paso 4 — Crea el `.gitignore`



Este archivo le dice a Git qué \*\*no\*\* subir. Crea un archivo llamado exactamente `.gitignore` (sin nombre antes del punto) con este contenido:
